    ...
    return (
        <div className="bg-blue-800 min-h-screen">
            ...
            <div className="flex flex-col ml-20 mt-20 items-start justify-start bg-blue-800"> 
                <Image
                src="https://avatars.mds.yandex.net/i?id=dfd4773dd98724b64e1a08f158e1ebeafb82c557-4231170-images-thumbs&n=13"  alt="Guitar"
                width={400}
                height={150}
                className="mt-5"
                />
            ...
            <div className="flex absolute flex-col text-4xl top-50 right-0 bg-blue-800  mr-150">
                <div>super cool guitar</div> <br/>
                <div>makes <span className="text-orange-600">almost fun</span> noises</div> <br/>
                <div><span className="text-red-600">PRICE:</span> 500$</div>
            </div>
            <Link 

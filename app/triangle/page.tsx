    ...
    return (
        <div className="bg-blue-800 min-h-screen">
            ...
            <div className="flex flex-col ml-20 mt-20 items-start justify-start bg-blue-800"> 
                <Image
                src="https://avatars.mds.yandex.net/i?id=7dccb3050066b862db216c4e3e36ed41690f30f2-3839645-images-thumbs&n=13"  alt="Piano"
                width={400}
                height={150}
                className="mt-5"
                />
            ...
            <div className="flex absolute flex-col text-4xl top-50 right-0 bg-blue-800  mr-150">
                ...
                <div>makes <span className="text-orange-600">simple</span> noises</div> <br/>
